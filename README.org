...
- Q. Why bother writing a program to create initialisms for you when you can
  just do it by hand?
- A. For a few sentences, yes, that is easy. For an entire script, however, it
  is tedious, error-prone, and difficult. This program works perfectly for you
